                  ...
                  <Card.Body>
                    ...
                    <Row className="d-flex align-items-center mb-3">
                      <Col xs={12} md={6} className="d-flex align-items-center">
                        ...
                        {bike.status.toLowerCase() === 'available' && (
                          <Button variant="primary" onClick={() => navigate('/viewBikeDetails', { state: { bike } })} className='d-flex align-items-center' style={{ fontSize: '0.875rem', padding: '0.5rem 1rem', minWidth: '120px' }}>
