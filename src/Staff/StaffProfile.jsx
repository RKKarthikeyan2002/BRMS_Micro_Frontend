...
function StaffProfile() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:8080/staff/${staffId}`)
        .then(response => {
            ...
            setFormData({
                ...
                age: calculateAge(staffData.dob),
                dob: staffData.dob || '',
    ...
    const handleSave = () => {
        ...
        axios.put(`http://localhost:8080/staff/update`, formData)
        .then(response => {
    ...
    const handlePasswordChange = () => {
        ...
        axios.put(`http://localhost:8080/staff/update/${staffId}/password`, password)
        .then((response) => {
